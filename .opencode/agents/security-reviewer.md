---
description: Use for auth, payment, secrets, user-input handling, database queries, file system operations, external API calls, or cryptographic code — anything on the OWASP Top 10 surface. Prefer configuring OpenCode's larger/most capable model for security-critical code.
mode: subagent
permission:
  edit: deny
  webfetch: deny
