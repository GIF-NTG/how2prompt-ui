---
name: planner
description: Use PROACTIVELY before any multi-file feature (>= 5 files) or architectural change. Decomposes a feature request into small, independently verifiable tasks with explicit file paths and verify steps. Wraps the `writing-plans` Superpowers skill.
