...
const NAV_ITEM_ACTIVE = 'bg-[#E7EAFC] font-semibold text-[#3652E0] dark:bg-[#262C4A] dark:text-[#8493FF]'
...
export function AdminLayout() {
  ...
  return (
    <div className="grid min-h-screen grid-cols-1 bg-[#F3F5F0] text-[#1B1D1B] dark:bg-[#14171A] dark:text-[#ECEEE8] md:grid-cols-[260px_minmax(0,1fr)]">
      ...
      <div className="flex min-w-0 flex-col gap-7 px-5 pb-16 pt-6 sm:px-[clamp(1.25rem,3vw,2.5rem)]" key={location.pathname}>
        <Outlet />
      </div>
    </div>
  )
